...
DATA_TRANSFORMATION_PREPROCESSED_OBJECT_FILE_NAME_KEY = "preprocessing_dir"
...
MODEL_TRAINER_BASE_ACCURACY_KEY = "model_file_name"

# model evaluation config related variable
